...
object SubtitleMatchHelper {
    ...
    suspend fun matchSubtitle(Retrofit: RetrofitModule, videoPath: String): MutableList<SubtitleSourceBean> {
        val sourceList = mutableListOf<SubtitleSourceBean>()
        sourceList.addAll(matchThunderSubtitle(Retrofit, videoPath))
        sourceList.addAll(matchShooterSubtitle(Retrofit, videoPath))
        return sourceList
    }

    private suspend fun matchThunderSubtitle(Retrofit: RetrofitModule, videoPath: String): MutableList<SubtitleSourceBean> {
    ...
    private suspend fun matchShooterSubtitle(Retrofit: RetrofitModule, videoPath: String): MutableList<SubtitleSourceBean> {
        val subtitleList = mutableListOf<SubtitleSourceBean>()
