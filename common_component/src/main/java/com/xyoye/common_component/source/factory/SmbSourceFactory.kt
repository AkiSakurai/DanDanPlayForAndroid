...
object SmbSourceFactory {
    ...
    suspend fun create(DanmuUtils: DanmuUtilsModule, builder: VideoSourceFactory.Builder): SmbMediaSource? {
        ...
        val (episodeId, danmuPath) = getVideoDanmu(DanmuUtils, history, builder.rootPath, smbFile, extSources)
