...
object LocalMediaSourceHelper {
    suspend fun getHistoryPosition(DanmuUtils: DanmuUtilsModule, video: VideoEntity): Long {
    ...
    suspend fun getVideoDanmu(DanmuUtils: DanmuUtilsModule, video: VideoEntity): Pair<Int, String?> {
        //当前视频已绑定弹幕
    ...
    suspend fun getVideoSubtitle(DanmuUtils: DanmuUtilsModule, video: VideoEntity): String? {
        //当前视频已绑定字幕
